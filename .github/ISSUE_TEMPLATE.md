...
This issue tracker is only for technical issues related to Nodex Core.
General Nodex questions and/or support requests and are best directed to the [Nodex Discord](https://discord.gg/sbgdcdv).
...
### What version of Nodex Core are you using?

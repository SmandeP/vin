...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Nodex test Developers June 12 2018";
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x10)(0x72)(0xb0)(0x61).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x01)(0x04)(0x31)(0x52).convert_to_container<std::vector<unsigned char> >();

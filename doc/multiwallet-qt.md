...
In order to support loading of multiple wallets in nodex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodex.cpp.
...
Changes to nodex.cpp
----------------------
nodex.cpp is the entry point into nodex-qt, and as such, will require some minor modifications to provide hooks for

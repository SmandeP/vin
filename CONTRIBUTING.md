Contributing to Nodex Core
============================

The Nodex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodex Core project, and is not to be
confused with overall Nodex Network Protocol consensus changes.

Whether a pull request is merged into Nodex Core rests with the project merge
...
Patches that change Nodex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nodex consensus, it must have been
...
The project leader is the release manager for each Nodex Core release.

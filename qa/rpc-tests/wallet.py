...
#   c) node1 mines 32 blocks, so now node 0 has 60001dxd, node 1 has 4250dxd, node2 has none.
#   d) node0 sends 601 dxd to node2, in two transactions (301 dxd, then 300 dxd).
